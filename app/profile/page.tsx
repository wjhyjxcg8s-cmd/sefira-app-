...
const translations = {
  ...
  de: {
    ...
    displayNamePlaceholder: "Name, der anderen Nutzern angezeigt wird",
    birthDate: "Geburtsdatum",
    gender: "Geschlecht",
    genderMale: "Männlich",
    genderFemale: "Weiblich",
    genderOther: "Sonstiges",
    ...
    saved: "Gespeichert!",
    cancel: "Abbrechen",
    notLoggedIn: "Bitte melden Sie sich an, um Ihr Profil anzuzeigen.",
    ...
    deleteWarningTitle: "Möchten Sie Ihr Konto wirklich löschen?",
    deleteContinue: "Weiter",
    deleteCancel: "Abbrechen",
    deleteReasonTitle: "Warum verlassen Sie uns?",
    deleteReason1: "Die App hat mir nicht gefallen, das Design ist schwach",
    deleteReason2: "Ich konnte nichts Passendes finden",
    deleteReason3: "Ich brauche es nicht mehr",
    deleteRatingTitle: "Bewerten Sie uns von 1 bis 10",
    deleteFeedbackTitle: "Haben Sie Anmerkungen? (Optional)",
    deleteFeedbackPlaceholder: "Schreiben Sie Ihre Gedanken hier...",
    deleteOtpTitle: "Ein Bestätigungscode wurde an Ihre E-Mail gesendet.",
    deleteOtpPlaceholder: "6-stelligen Code eingeben",
    deleteConfirmBtn: "Konto löschen",
    deleteOtpInvalid: "Ungültiger Code. Bitte versuchen Sie es erneut.",
    deleteOtpExpired: "Code abgelaufen. Bitte erneut senden.",
                ...
                <div className="grid grid-cols-5 gap-2">
                  {Array.from({ length: 10 }, (_, i) => i + 1).map(n => (
                    <button
                      ...
                      className={`py-2.5 rounded-xl text-sm font-bold border-2 transition-all active:scale-95 ${deleteRating === n ? "bg-orange-500 border-orange-500 text-white shadow-md shadow-orange-500/25" : "border-stone-200 text-stone-600 hover:border-orange-300 hover:text-orange-700"}`}
                    >
                      {n}
                    </button>
                  ))}
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-stone-100 overflow-hidden">
                        ...
                        return (
                          <button
                            ...
                            className={`relative flex flex-col items-center gap-1.5 py-3 px-2 rounded-xl border-2 font-bold text-xs transition-all duration-200 active:scale-95 ${
                              selected
                                ? "border-orange-400 bg-orange-50 text-orange-800 shadow-md shadow-orange-500/15"
                          ...
                          >
                            ...
                            {selected && (
                              <span className="absolute top-1.5 right-1.5 w-3.5 h-3.5 rounded-full bg-orange-500/20 flex items-center justify-center text-[8px] text-orange-700">✓</span>
                            )}
                          </button>
                        );
                      })}
          ...
          <div className="p-6 sm:p-8 flex flex-col gap-3 border-t border-stone-100">
            ...
            <div className="grid grid-cols-2 gap-3">
              <Link
                href="/my-listings"
                className="py-3.5 rounded-xl font-bold text-sm text-center border-2 border-stone-200 text-stone-700 hover:border-orange-300 hover:bg-orange-50 hover:text-orange-800 active:scale-95 transition-all duration-200 flex items-center justify-center gap-2"
              >
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4">
