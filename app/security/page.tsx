    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Kiracı veya ev sahibiyle buluşmadan önce kimlik doğrulamasını platform üzerinden talep edin.",
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Request identity verification through the platform before meeting a tenant or landlord.",
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "قبل از ملاقات با مستأجر یا مالک، تأیید هویت را از طریق پلتفرم درخواست کنید.",
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "اطلب التحقق من الهوية عبر المنصة قبل مقابلة مستأجر أو مالك.",
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Fordern Sie die Identitätsprüfung über die Plattform an, bevor Sie einen Mieter oder Vermieter treffen.",
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Запросите верификацию личности через платформу перед встречей с арендатором или арендодателем.",
