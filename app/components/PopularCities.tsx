  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-x-0 bottom-0 p-5">
        ...
        <div className={`flex items-center mt-2 ${hasCount ? "justify-between" : "justify-end"}`}>
          {hasCount && (
            <div className="flex items-baseline gap-1.5">
              <span className="text-sm font-black text-white drop-shadow">{count.toLocaleString(lang === "tr" ? "tr-TR" : "en-US")}</span>
...
export default function PopularCities({ lang, onCityClick }: PopularCitiesProps) {
  ...
  // Real per-city counts, not the fabricated numbers this section used to
  // hardcode. One lightweight query for all non-deleted listing cities, then
  // bucketed client-side with the same bidirectional match used by the
  // click-through filter in LatestListings — so a card's count always agrees
  // with what actually shows up after tapping it (e.g. "Washington DC" must
  // count listings stored as plain "Washington").
  useEffect(() => {
    let active = true;
    (async () => {
      ...
      for (const city of CITIES) {
        result[city.key] = data.filter((l: { city: string | null }) => cityMatches(l.city || "", city.name)).length;
      }
      setCounts(result);
    })();
    return () => { active = false; };
  ...
  return (
    <section ref={ref} className="max-w-7xl mx-auto px-5 lg:px-8 pt-section pb-20">
      ...
      <div className="grid grid-cols-2 gap-3 lg:hidden">
        <CityCard city={istanbul}     lang={lang} inView={inView} delay={0.06} className="h-40" imgSizes="50vw" t={t} featured onCityClick={onCityClick} count={counts[istanbul.key]} />
        <CityCard city={washingtonDc} lang={lang} inView={inView} delay={0.12} className="h-40" imgSizes="50vw" t={t} onCityClick={onCityClick} count={counts[washingtonDc.key]} />
        <CityCard city={newYork}      lang={lang} inView={inView} delay={0.18} className="h-40" imgSizes="50vw" t={t} onCityClick={onCityClick} count={counts[newYork.key]} />
        <CityCard city={paris}        lang={lang} inView={inView} delay={0.24} className="h-40" imgSizes="50vw" t={t} onCityClick={onCityClick} count={counts[paris.key]} />
        <CityCard city={barcelona}    lang={lang} inView={inView} delay={0.30} className="h-40" imgSizes="50vw" t={t} onCityClick={onCityClick} count={counts[barcelona.key]} />
        <CityCard city={berlin}       lang={lang} inView={inView} delay={0.36} className="h-40" imgSizes="50vw" t={t} onCityClick={onCityClick} count={counts[berlin.key]} />
        <CityCard city={dubai}        lang={lang} inView={inView} delay={0.42} className="h-40" imgSizes="50vw" t={t} onCityClick={onCityClick} count={counts[dubai.key]} />
        <CityCard city={moscow}       lang={lang} inView={inView} delay={0.48} className="h-40" imgSizes="50vw" t={t} onCityClick={onCityClick} count={counts[moscow.key]} />
        <CityCard city={tehran}       lang={lang} inView={inView} delay={0.54} className="h-40" imgSizes="50vw" t={t} onCityClick={onCityClick} count={counts[tehran.key]} />
        <CityCard city={manchester}   lang={lang} inView={inView} delay={0.60} className="h-40" imgSizes="50vw" t={t} onCityClick={onCityClick} count={counts[manchester.key]} />
        <CityCard city={london}       lang={lang} inView={inView} delay={0.66} className="h-40" imgSizes="50vw" t={t} onCityClick={onCityClick} count={counts[london.key]} />
        <CityCard city={frankfurt}    lang={lang} inView={inView} delay={0.72} className="h-40" imgSizes="50vw" t={t} onCityClick={onCityClick} count={counts[frankfurt.key]} />
      </div>
      ...
      <div className="hidden lg:flex gap-4 h-[580px]">
        ...
        <div className="flex-[2] min-w-0">
          <CityCard city={istanbul} lang={lang} inView={inView} delay={0.06} className="h-full" imgSizes="38vw" t={t} featured onCityClick={onCityClick} count={counts[istanbul.key]} />
        </div>
        ...
        <div className="flex-[3] min-w-0 flex flex-col gap-4">
          ...
          <div className="flex gap-4 flex-1">
            <div className="flex-1">
              <CityCard city={washingtonDc} lang={lang} inView={inView} delay={0.14} className="h-full" imgSizes="14vw" t={t} onCityClick={onCityClick} count={counts[washingtonDc.key]} />
            </div>
            <div className="flex-1">
              <CityCard city={newYork}      lang={lang} inView={inView} delay={0.20} className="h-full" imgSizes="14vw" t={t} onCityClick={onCityClick} count={counts[newYork.key]} />
            </div>
            <div className="flex-1">
              <CityCard city={paris}        lang={lang} inView={inView} delay={0.26} className="h-full" imgSizes="14vw" t={t} onCityClick={onCityClick} count={counts[paris.key]} />
            </div>
          </div>
          {/* Bottom row: Barcelona + Berlin + Dubai */}
          <div className="flex gap-4 flex-1">
            <div className="flex-1">
              <CityCard city={barcelona} lang={lang} inView={inView} delay={0.32} className="h-full" imgSizes="14vw" t={t} onCityClick={onCityClick} count={counts[barcelona.key]} />
            </div>
            <div className="flex-1">
              <CityCard city={berlin}    lang={lang} inView={inView} delay={0.38} className="h-full" imgSizes="14vw" t={t} onCityClick={onCityClick} count={counts[berlin.key]} />
            </div>
            <div className="flex-1">
              <CityCard city={dubai}     lang={lang} inView={inView} delay={0.44} className="h-full" imgSizes="14vw" t={t} onCityClick={onCityClick} count={counts[dubai.key]} />
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="hidden lg:grid lg:grid-cols-5 gap-4 mt-4 h-44">
        <CityCard city={moscow}     lang={lang} inView={inView} delay={0.50} className="h-full" imgSizes="18vw" t={t} onCityClick={onCityClick} count={counts[moscow.key]} />
        <CityCard city={tehran}     lang={lang} inView={inView} delay={0.56} className="h-full" imgSizes="18vw" t={t} onCityClick={onCityClick} count={counts[tehran.key]} />
        <CityCard city={manchester} lang={lang} inView={inView} delay={0.62} className="h-full" imgSizes="18vw" t={t} onCityClick={onCityClick} count={counts[manchester.key]} />
        <CityCard city={london}     lang={lang} inView={inView} delay={0.68} className="h-full" imgSizes="18vw" t={t} onCityClick={onCityClick} count={counts[london.key]} />
        <CityCard city={frankfurt}  lang={lang} inView={inView} delay={0.74} className="h-full" imgSizes="18vw" t={t} onCityClick={onCityClick} count={counts[frankfurt.key]} />
      </div>
    </section>
  );
}
