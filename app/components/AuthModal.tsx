...
const authT = {
  ...
  en: {
    ...
    resetEmailLabel: "Enter your email address",
  ...
  fa: {
    ...
    resetEmailLabel: "ایمیل خود را وارد کنید",
  ...
  ru: {
    ...
    successRegister: "Аккаунт создан! Проверьте почту для подтверждения.",
    switchToRegister: "Нет аккаунта?",
    switchToLogin: "Уже есть аккаунт?",
    switchRegisterLink: "Регистрация",
    switchLoginLink: "Войти",
    subtitle: "Добро пожаловать в Sefira",
    subtitleRegister: "Начните бесплатно",
    forgotPassword: "Забыли пароль?",
    forgotTitle: "Сброс пароля",
    resetEmailLabel: "Введите адрес эл. почты",
    sendResetLink: "Отправить ссылку",
    backToLogin: "Вернуться к входу",
    resetSuccess: "Ссылка для сброса пароля отправлена на вашу почту.",
  },
};
      ...
      >
        ...
        <div className="p-8">
          ...
          {forgotView ? (
            ...
            <div>
              <h2 className="text-2xl font-black text-stone-900 mb-6">{t.forgotTitle}</h2>
              ...
              {forgotSuccess ? (
                <div className="py-6 text-center">
                  ...
                  <button
                    onClick={closeForgot}
                    className="text-sm font-bold text-orange-500 hover:text-orange-700 underline underline-offset-2"
                  >
                    {t.backToLogin}
                  </button>
                </div>
                ...
                <form onSubmit={handleForgotSubmit} className="space-y-4">
                  ...
                  {forgotError && (
                    <div className="flex items-start gap-2 p-3 rounded-xl bg-rose-50 border border-rose-200">
                      ...
                      <p className="text-xs text-rose-700 font-medium">{forgotError}</p>
                    </div>
                  )}
              ...
              {success ? (
                <div className="py-8 text-center">
                  ...
                  <button
                    ...
                    className="mt-4 text-sm font-bold text-orange-500 hover:text-orange-700 underline underline-offset-2"
                  >
                    {t.switchLoginLink}
                  </button>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <p className="text-center text-xs text-stone-500 pt-1">
                    ...
                    <button
                      ...
                      className="font-bold text-orange-500 hover:text-orange-700 underline underline-offset-2"
                    >
