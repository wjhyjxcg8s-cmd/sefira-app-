  ...
  return (
    <div className="min-h-screen bg-stone-50">
      ...
      <div className="sticky top-0 z-10 bg-white shadow-sm px-4 py-3 flex items-center gap-3">
        ...
        {listings.length > 0 && (
          <span className="bg-orange-100 text-orange-600 text-xs rounded-full px-2 py-1 font-medium">
      ...
      <div className="max-w-2xl mx-auto px-4 py-5">
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-24 gap-4">
            ...
            <button
              onClick={() => router.push("/")}
              className="mt-2 bg-orange-500 hover:bg-orange-600 text-white font-semibold px-6 py-2.5 rounded-full transition-colors"
            >
                ...
                >
                  ...
                  <div className="p-3">
                    ...
                    <button
                      ...
                      className="text-orange-500 text-xs font-medium mt-1.5 block"
                    >
