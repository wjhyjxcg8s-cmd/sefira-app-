        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-3">
          <div className="bg-white rounded-2xl px-5 py-3 border border-gray-100 shadow-sm flex items-center gap-3 shrink-0 flex-wrap">
            <span className="text-sm text-gray-500">
              <span className="text-2xl font-bold text-orange-500">{activeCount}</span> aktif
            </span>
          ...
          <button
            ...
            className="bg-orange-500 text-white px-4 py-2.5 rounded-xl text-sm font-bold hover:bg-orange-600 transition-colors shrink-0"
          >
            🔄 Yenile
          </button>
        </div>
