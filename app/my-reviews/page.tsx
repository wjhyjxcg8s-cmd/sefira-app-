...
export default function MyReviewsPage() {
  ...
  return (
    <div className="min-h-screen bg-stone-50" dir={isFa ? "rtl" : "ltr"}>
      {/* Navbar */}
      <nav dir="ltr" className="fixed top-0 left-0 right-0 z-50 bg-white/90 backdrop-blur-xl border-b border-stone-200 shadow-sm">
      ...
      <div className="pt-24 pb-24 px-5 max-w-2xl mx-auto">
        ...
        <div className="flex items-start gap-3 bg-orange-50 border border-orange-200 rounded-2xl px-4 py-3.5 mb-7">
          ...
          <p className="text-sm text-orange-800 leading-relaxed">{t.banner}</p>
        </div>
                ...
                <div className="px-5 pb-5">
                  ...
                  {confirmDelete ? (
                    ...
                    <div className="flex gap-2">
                      <button
                        onClick={startEdit}
                        className="flex items-center gap-1.5 px-4 py-2 rounded-xl bg-orange-50 text-orange-600 text-sm font-semibold hover:bg-orange-100 active:scale-95 transition-all border border-orange-200"
                      >
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-3.5 h-3.5">
