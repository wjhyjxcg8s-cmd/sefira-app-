      ...
      <div className="pt-24 pb-28 px-5 max-w-2xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-6 gap-3">
          <h1 className="text-2xl font-black text-stone-900 flex items-center gap-3">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-6 h-6 text-teal-500">
              <rect x="3" y="3" width="18" height="18" rx="2" /><line x1="3" y1="9" x2="21" y2="9" /><line x1="9" y1="21" x2="9" y2="3" />
            </svg>
            {t.title}
          </h1>
          <Link
            href="/create-listing"
            className="flex items-center gap-1.5 bg-gradient-to-r from-teal-500 to-amber-500 text-white font-bold text-sm px-4 py-2 rounded-xl shadow-lg shadow-teal-500/25 hover:opacity-90 active:scale-95 transition-all"
          >
        ...
        {listings.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-20 gap-5 text-center">
            ...
            <Link
              href="/create-listing"
              className="bg-gradient-to-r from-teal-500 to-amber-500 text-white font-bold px-6 py-3 rounded-xl shadow-lg shadow-teal-500/25 hover:opacity-90 transition-all active:scale-95 text-sm flex items-center gap-2"
            >
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" className="w-4 h-4">
                <line x1="12" y1="5" x2="12" y2="19" /><line x1="5" y1="12" x2="19" y2="12" />
              </svg>
                  ...
                  <div className="p-4">
                    <div className="flex items-start justify-between gap-2 mb-3">
                      <div className="min-w-0">
                        ...
                        {typeLabel && (
                          <span className="inline-block mt-1 text-xs font-semibold text-teal-700 bg-teal-50 px-2 py-0.5 rounded-full">
                            {typeLabel}
                          </span>
                        )}
                      </div>
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        className="flex-1 flex items-center justify-center gap-1.5 bg-gradient-to-r from-teal-500 to-amber-500 text-white font-bold text-sm py-2.5 rounded-xl shadow-md shadow-teal-500/20 hover:opacity-90 active:scale-95 transition-all"
                      >
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" className="w-4 h-4">
