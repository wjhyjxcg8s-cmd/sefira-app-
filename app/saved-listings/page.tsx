  ...
  if (!user) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-stone-50 gap-5 p-6">
        <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-orange-600 to-amber-500 flex items-center justify-center shadow-lg shadow-orange-600/30">
        ...
        <Link
          href="/"
          className="bg-gradient-to-r from-orange-600 to-amber-500 text-white font-bold px-8 py-3 rounded-xl shadow-lg shadow-orange-600/25 hover:opacity-90 transition-all active:scale-95"
        >
          {t.goHome}
        </Link>
      </div>
    ...
    <div className="min-h-screen bg-stone-50" dir={lang === "fa" || lang === "ar" ? "rtl" : "ltr"}>
      ...
      <nav dir="ltr" style={{ transform: "translateZ(0)", WebkitTransform: "translateZ(0)", willChange: "transform" }} className="fixed top-0 left-0 right-0 w-full z-[9999] bg-white border-b border-stone-200 shadow-sm">
        <div className="max-w-2xl mx-auto px-5 h-16 flex items-center justify-between gap-4">
          <Link href="/" className="flex items-center gap-2 group flex-shrink-0">
            <div className="w-8 h-8 rounded-xl bg-gradient-to-br from-orange-600 to-amber-500 flex items-center justify-center font-black text-sm text-white shadow-lg shadow-orange-600/30 group-hover:scale-110 transition-all duration-300">
              S
            </div>
      ...
      <div className="pt-24 pb-16 px-5 max-w-2xl mx-auto">
        ...
        <h1 className="text-2xl font-black text-stone-900 mb-6 flex items-center gap-3">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-6 h-6 text-orange-600">
            <path d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z" />
          </svg>
          {t.title}
        </h1>
        ...
        {fetching ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 gap-5 text-center">
            ...
            <Link
              href="/"
              className="bg-gradient-to-r from-orange-600 to-amber-500 text-white font-bold px-6 py-3 rounded-xl shadow-lg shadow-orange-600/25 hover:opacity-90 transition-all active:scale-95 text-sm"
            >
              {t.emptyAction}
            </Link>
          </div>
            ...
            {listings.map((l) => (
              ...
              >
                <div className="flex items-start justify-between gap-3">
                  ...
                  {l.rent != null && (
                    <span className="flex-shrink-0 text-sm font-black text-orange-600">
