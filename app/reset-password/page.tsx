          ...
          <div className="p-8">
            ...
            <div className="flex items-center gap-2 mb-8">
              <Link href="/" className="flex items-center gap-2">
                <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-orange-600 to-amber-500 flex items-center justify-center font-black text-sm text-white shadow-lg shadow-orange-600/30">
                  S
                </div>
            ...
            {tokenValid === false ? (
              <div className="py-6 text-center">
                ...
                <Link
                  href="/"
                  className="inline-block px-6 py-2.5 rounded-xl font-bold text-sm text-white bg-gradient-to-r from-orange-600 to-amber-500 shadow-lg shadow-orange-600/25 hover:opacity-90 transition-all active:scale-95"
                >
                  {tr.goHome}
                </Link>
              </div>
              ...
              <div className="py-12 flex justify-center">
                <svg className="animate-spin w-8 h-8 text-orange-600" viewBox="0 0 24 24" fill="none">
            ...
            {success ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full py-3.5 rounded-xl font-bold text-sm text-white bg-gradient-to-r from-orange-600 to-amber-500 hover:opacity-95 transition-all duration-200 shadow-lg shadow-orange-600/25 hover:shadow-xl hover:shadow-orange-600/40 active:scale-[0.98] disabled:opacity-60 disabled:cursor-not-allowed"
                >
                  {loading ? (
